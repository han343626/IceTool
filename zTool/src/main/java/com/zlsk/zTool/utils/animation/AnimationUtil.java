...
public class AnimationUtil {
    ...
    public static void getScaleAnimation(){

    }

    public static Animation getRightInAnimation(Context context){
        return AnimationUtils.loadAnimation(context, R.anim.anim_right_in);
    }

    public static Animation getRightOutAnimation(Context context){
        return AnimationUtils.loadAnimation(context, R.anim.anim_right_out);
    }
    ...
    public static void startScaleAnimationRepeat(View view){
        ObjectAnimator scaleAnimatorX = ObjectAnimator.ofFloat(view, "scaleX", 1.0f,0.3f, 1.0f,1.0f,1.0f,0.3f, 1.0f);
        scaleAnimatorX.setRepeatMode(ValueAnimator.RESTART);
        scaleAnimatorX.setRepeatCount(Animation.INFINITE);
        scaleAnimatorX.setInterpolator(new AccelerateInterpolator());

        ObjectAnimator scaleAnimatorY = ObjectAnimator.ofFloat(view, "scaleY", 1.0f,0.3f, 1.0f,1.0f,1.0f,0.3f, 1.0f);
        scaleAnimatorY.setRepeatMode(ValueAnimator.RESTART);
        scaleAnimatorY.setRepeatCount(Animation.INFINITE);
        scaleAnimatorY.setInterpolator(new AccelerateInterpolator());
