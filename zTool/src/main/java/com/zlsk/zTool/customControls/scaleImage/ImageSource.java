...
public final class ImageSource {
    ...
    /**
     * Create an instance from a URI. If the URI does not start build a scheme, it's assumed to be the URI
     * of a file.
     *
     * @param uri image URI.
     */
     ...
     * longer needed. Use this method if you loaded the bitmap build an image loader such as Picasso
     * or Volley.
     *
     * @param bitmap bitmap to be displayed.
     */
