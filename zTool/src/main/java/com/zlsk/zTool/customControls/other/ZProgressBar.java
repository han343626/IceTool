...
public class ZProgressBar extends View implements Runnable {
    ...
    private String[] showText = new String[]{"下载中","继续","下载完成"};
    ...
    private void init() {
        ...
        flikerBitmap = BitmapFactory.decodeResource(getResources(), R.drawable.icon_bg_flicker);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        switch (heightSpecMode) {
            case MeasureSpec.AT_MOST:
                height = TransPixelUtil.dip2px(getContext(),DEFAULT_HEIGHT_DP);
                break;
    ...
    public void run() {
        ...
        try {
            while (!isStop && !thread.isInterrupted()) {
                flickerLeft += TransPixelUtil.dip2px(getContext(),5);
                float progressWidth = (progress / maxProgress) * getMeasuredWidth();
